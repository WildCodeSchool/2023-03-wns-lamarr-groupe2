...
export const HeaderBarModale: FC<HeaderBarModaleProps> = ({
  setShowModale,
}) => {
  ...
  return (
    <div
      ...
      className="absolute right-[9%] top-20 z-[999] w-60 h-28"
      style={modaleStyle}
    >
      <div className=" flex w-44 flex-col justify-center h-full">
        <div className="pl-3 font-bold ">
          <div
            ...
            className="pt-3   hover:text-element-bg"
          >
            paramètres
          </div>
          ...
          <div
            ...
            className="uppercase hover:text-element-bg"
          >
            déconnexion
          </div>
        </div>
