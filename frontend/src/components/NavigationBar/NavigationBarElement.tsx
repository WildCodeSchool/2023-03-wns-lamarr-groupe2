  ...
  return (
    <div className="relative">
      ...
      {link === "notifications" && notificationsUnreadNumber !== 0 && (
        <div className="absolute inline-flex items-center justify-center w-6 h-6 text-[14px] font-bold text-white  border-2 border-primary-dark rounded-full bottom-5 -right-5  bg-primary-danger">
