...
export const Challenge: FC<{
  ...
  const isOwner = challenge?.challenge.creator?.id === userId;
  const numberOfEcoActions = challenge.challenge.ecoActions?.length;
      ...
      <div className=" flex h-full justify-between ">
        <div className="flex flex-col  w-9/12">
          <div className="flex-grow">
            ...
            <ProgressionBar value={challenge.progressPercentage} />
            <p className="text-main-p my-2 text-primary-dark">
              Nb d'éco-gestes : {numberOfEcoActions ?? 0}
            </p>
          </div>
          <TimeLeft challenge={challenge.challenge} />
        </div>
        ...
        <div className=" flex flex-col  lg:flex lg:flex-col  w-3/12 justify-between  items-end lg:items-end lg:justify-between">
          <div className="lg:flex">
            ...
            <NavBtn
              type="specific"
              link={`/challenges/${challenge?.challenge.id}`}
            />
          </div>
