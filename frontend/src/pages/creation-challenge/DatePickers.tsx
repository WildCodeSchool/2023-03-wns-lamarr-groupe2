...
const DatePickers: FC<DatePickersProps> = ({
  ...
  return (
    <div className="w-full flex items-center justify-evenly xl:justify-start xl:gap-8">
      ...
      <div className=" flex gap-1 items-center pt-3">
        <div className=" flex flex-col  items-center pt-3">
          ...
          />
          <div className="flex w-full justify-end items-center gap-2 h-6 pt-1"></div>
        </div>
      </div>
      ...
      <div className="flex gap-1  items-center  pt-3 xl:gap-6">
        ...
        <div className=" flex flex-col  items-center pt-3">
          ...
          />
          <div
            onClick={handleUseTodayAsEndDate}
            className="flex w-full justify-end items-center gap-2 pt-1"
          >
