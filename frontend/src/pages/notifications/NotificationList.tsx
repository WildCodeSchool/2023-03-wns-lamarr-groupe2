...
const NotificationList = () => {
  ...
  const filtredNotifications = isFiletered
    ...
    <div className="xxl:px-24">
      <div className="flex gap-3 items-center w-full justify-end mb-2">
        <button
          ...
          className={`${
            isFiletered ? "text-tertiary-dark" : "text-primary-good"
          }`}
        >
          Tout
        </button>
        <button
          ...
          className={`${
            isFiletered ? "text-primary-good" : "text-tertiary-dark"
          }`}
        >
          Non lu
        </button>
