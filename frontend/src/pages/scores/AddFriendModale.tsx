              ...
              <div className="bg-main-bg   pt-5 pb-4  sm:pb-4">
                <div className="flex  items-center  justify-center">
                  <div
                    ...
                    className="pl-3 bg-light mx-3 md:mx-0 flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-main-white"
                  >
                    <img
                      src={close}
                      alt="close modale"
                  ...
                  <div className=" w-full mt-3  mr-12 text-center sm:mt-0 sm:ml-4 sm:text-left"></div>
                </div>
