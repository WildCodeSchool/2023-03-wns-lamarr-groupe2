...
const BoardRow: FC<BoardRowProps> = ({ index }) => {
    return (
        <tr className='border-b-2  border-b-secondary-dark'>
            <td className='h-20'>
                <div className='flex items-center gap-6'>
                    <p className='font-bold  text-[24px]'>{index + 1}</p>
                    <ProfilePicture size='mediumPic' />
                    <p>Username</p>
                </div>
            </td>
            <td className='text-center hidden md:table-cell font-bold'>5</td>
            <td className='text-center'>
                <div className="flex gap-2 items-center mr-6 justify-center lg:w-3/5 xl:w-3/5  xxl:w-2/5 xl:w-2/5 bg-primary-attention rounded-small ">
                    <div className="font-bold  text-[25px]">186</div>
